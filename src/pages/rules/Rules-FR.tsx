        ...
        <div id='rules' className='page'>            
            <div className='wrapper'>
                ...
                <section id='rules--introduction' className='section'>
                    ...
                    <p className='text'>
                        L'heure est à la guerre et il semble que toute alliance soit désormais caduque
                        au Japon féodal. De riches seigneurs s'affrontent aux quatre coins de la nation
                        afin de prendre le contrôle de trois précieuses commodités: l'appui de seigneurs
                    ...
                    <p className='text'>
                        ...
                        toute authorité et est maintenant réduite à jouer un rôle de figurant. À travers tout le
                ...
                <section id='rules--playing' className='section'>
                    <h2 className='title title--section'>Déroulement du jeu</h2>
                    <p className='text'>
